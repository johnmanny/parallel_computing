...
*/
void initExamples(std::vector<example> exampleSet) {
    ...
    cout << "\tLast example info: " << exampleSet[exampleNum-1].inputsByOrder[0] << endl;
...
*/
void backPropLearning(std::vector<example> examplesArr, neuralNet * nn) {
...
//////////////////////////////////////////////////////
void predictExamples(neuralNet * nn, std::vector<example> examplesArr) {
...
int main(int argc, char * argv[]) {
    ...
    std::vector<example> exampleSet(EXAMPLECOUNT);
    exampleSet.reserve(EXAMPLECOUNT);
