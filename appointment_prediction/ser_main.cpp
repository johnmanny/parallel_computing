...
void initExamples(example * exampleSet) {
    ...
    for (exampleNum = 0; exampleNum < EXAMPLECOUNT; exampleNum++) {
        ...
        // ---------------------debugging:
        //cout << "EXAMPLE " << exampleNum << " SEX STRING: " << attr1 << endl;
	...
	// 1. days between section (scheduled day, appointment day) - NEED TO FINISH
        ...
        //cout << "Time elapsed between scheduled and appointment time: " << elapsed << endl;
        ...
        //-----------------------debugging
        //cout << "EXAMPLE " << exampleNum << " AGE STRING: " << attr1 << endl;
	...
	attr1[strlen(attr1) - 1] = '\0';			// replace newline with null terminating char
        ...
        // ----------------debugging
        //cout << "EXAMPLE " << exampleNum << " WENT TO APPT STRING: " << attr1 << " & VAL: " << exampleSet[exampleNum].inputsByOrder[9] << endl;
    }
...
void backPropLearning(example * examplesArr, neuralNet * nn) {
	...
	for (j = 0; j < TRAININGSET; j++) {
		...
		//		* nn->outputNeuron.derivedVal * nn->hiddenNeurons[x].activatedVal;
            ...
            learnRate = 1000.0/(1000.0 + exampleIterations);		// learning rate - decays as failed example iterations increase (increased precision)
...
void predictExamples(neuralNet * nn, example * examplesArr) {
    ...
    cout << "Number of Examples Correct: " <<  correct << "\tOut of " << TESTSET << " examples" << endl;
    cout << "Percent Correct: " <<  ((double)correct) / ((double)TESTSET)  << endl;
...
int main() {
    ...
    cout << "\tinitExample Runtime in seconds: " << ((end.tv_sec - start.tv_sec) * 
